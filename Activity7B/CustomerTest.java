...
/**
* Tests methods for the Customer class.
*/
public class CustomerTest {

   /** Tests setLocation method when city and state
   * are given within one input. 
   */
   ...
   */
   ...
   /**
   * Checks compareTo method when balances are equal.
   */
   ...
   /**
   * Checks compareTo method when balance 1 is less than
   * balance 2.
   */
   ...
   /**
   * Checks compareTo method when balance 1 is more than
   * balance 2.
   */
