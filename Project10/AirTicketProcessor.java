      ...
      while (scanFile.hasNext()) {
         ...
         // NonRefundable Ticket Type
            case 'N':
               ...
               NonRefundable nonRef = new NonRefundable(flightNum, itineraryIn, 
                  basePrice, fareAdjFactor, disFactor);
               addAirTicket(nonRef);
               break;
         ...
         // Business Ticket Type
            case 'B':
               ...
               Business bus = new Business(flightNum, itineraryIn, basePrice, 
                  fareAdjFactor, foodAndBev, entertainment);
               addAirTicket(bus);
               break;
...
*/
   ...
   /**
   * Will primarily be used in Project 11.
